  ...
  return (
    <div id='Projects' className='p-10 md:p-12 text-white'>
        ...
        <div className='py-12 px-8 flex flex-wrap gap-7 mx-20'>
            ...
            <ProjectCard title="Currency" main="This is a Currency Convertor App created using react. It makes use of Reusable components" Link="https://nimesh631.github.io/chai-aur-react/"/>
        </div>
    </div>
  )
}
