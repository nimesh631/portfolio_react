    ...
    <div id='Projects' className='p-10 md:p-12 text-white'>
        ...
        <div className='py-12 px-8 flex flex-wrap gap-7 mx-20'>
          <ProjectCard title="Todo" text="Demo" main="Feature-rich Todo App built with React and Redux Toolkit that offers complete CRUD operations and data persistence via Local Storage. Streamlined task management with an intuitive interface." Link="https://nimesh631.github.io/ReduxToolKitTodo/"/>
            <ProjectCard title="Expense Tracker" text="Demo" main="A simple and responsive expense tracking web app built with React, Redux Toolkit, and Vite. Users can add income and expense transactions, view real-time balance updates, and track financial summaries." Link="https://nimesh631.github.io/reduxtoolkitExpenseTracker/"/>
...
" Link="https://github.com/nimesh631/TaskProductApi"/>
 <ProjectCard title="Job Portal Backend" text="Repo" main="This is a comprehensive job portal and crowdfunding backend using Nest.js, TypeORM, PostgreSQL, and TypeScript. The system features CRUD operations, JWT authentication, and role-based authorization.
